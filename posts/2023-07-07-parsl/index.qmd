...
So say you have a normal python function you want to run but it takes 10 seconds to finish.
If you want to call that function normally you'll have to wait until it's finished running before you can do anything else.
...
Vocab:
- app: parsl instance of your function
- run in parallel: run multiple functions at the same time
- run asyncronously: run a function at the same time as others without interrupting main workflow
- submitting a job: calling a function that has a parsl decorator
